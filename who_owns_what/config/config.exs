...
config :who_owns_what, WhoOwnsWhatWeb.Endpoint,
  ...
  pubsub_server: WhoOwnsWhat.PubSub,
  live_view: [signing_salt: "/kdbilGu"]
...
config :tailwind,
  ...
  maplibre: [
    args: ~w(
      --input=vendor/maplibre-gl.css
      --output=../priv/static/assets/maplibre-gl.css
    ),
    cd: Path.expand("../assets", __DIR__)
  ]
