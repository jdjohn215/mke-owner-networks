defmodule WhoOwnsWhatWeb.CoreComponents do
  @moduledoc """
        ...
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-zinc-50">
            <td
              ...
              class={["table-cell relative p-0", col[:class], @row_click && "hover:cursor-pointer"]}
            >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WhoOwnsWhatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WhoOwnsWhatWeb.Gettext, "errors", msg, opts)
    end
  end
